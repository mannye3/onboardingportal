...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="{{ url('home') }}" class="logo logo-dark">
            <span class="logo-sm">
                <img src="assets/images/FMDQlogo.svg" height="40" alt="" height="22">
            </span>
            <span class="logo-lg">
                <img src="assets/images/FMDQlogo.svg" height="40" alt="" height="17">
            </span>
        </a>
        <!-- Light Logo-->
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarApps" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="ri-apps-2-line"></i> <span data-key="t-apps">Roles and Permissions</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ url('roles') }}" class="nav-link" data-key="t-calendar"> Roles </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('permissions') }}" class="nav-link" data-key="t-chat"> Permissions </a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarLayouts" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="las la-users"></i> <span data-key="t-apps">Users</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarLayouts">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ url('users') }}" class="nav-link" data-key="t-calendar">Internal Users</a>
                            </li>
                            {{-- <li class="nav-item">
                                <a href="{{ url('users') }}" class="nav-link" data-key="t-chat">external Users </a>
                            </li> --}}
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarAuth" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="ri-account-circle-line"></i> <span data-key="t-authentication">Market</span>
                    </a>
                        ...
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="#sidebarSuccessMsg" class="nav-link" data-bs-toggle="collapse" role="button"
                                    ...
                                    data-key="t-success-message"> PenDealer
                                </a>
                                <div class="collapse menu-dropdown" id="sidebarSuccessMsg">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="{{route('pendealer')}}" class="nav-link" data-key="t-basic">
                                                Dashboard </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{route('pendealer_tran')}}" class="nav-link" data-key="t-cover">
                                            Market Activity Report </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{route('pendealer_pfaTran')}}" class="nav-link" data-key="t-cover">PFA Transactions
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            {{-- <li class="nav-item">
                                <a href="#sidebarSignIn" class="nav-link" data-bs-toggle="collapse" role="button"
                                    aria-expanded="false" aria-controls="sidebarSignIn" data-key="t-signin"> Fixed Income
                                </a>
                                <div class="collapse menu-dropdown" id="sidebarSignIn">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="auth-signin-basic.html" class="nav-link" data-key="t-basic"> Fixed Income 
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="auth-signin-cover.html" class="nav-link" data-key="t-cover"> Market Activity
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="nav-item">
                                <a href="#sidebarSignUp" class="nav-link" data-bs-toggle="collapse" role="button"
                                    aria-expanded="false" aria-controls="sidebarSignUp" data-key="t-signup"> Derivatives
                                </a>
                                <div class="collapse menu-dropdown" id="sidebarSignUp">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="auth-signup-basic.html" class="nav-link" data-key="t-basic"> Derivatives
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="auth-signup-cover.html" class="nav-link" data-key="t-cover"> Market Activity
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="nav-item">
                                <a href="#sidebarLogout" class="nav-link" data-bs-toggle="collapse" role="button"
                                    aria-expanded="false" aria-controls="sidebarLogout" data-key="t-logout"> OTC FX Futures Trading
                                </a>
                                <div class="collapse menu-dropdown" id="sidebarLogout">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="auth-logout-basic.html" class="nav-link" data-key="t-basic"> OTC FX Futures Trading
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="auth-logout-cover.html" class="nav-link" data-key="t-cover"> Market Activity
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="nav-item">
                                <a href="#sidebarTwoStep" class="nav-link" data-bs-toggle="collapse" role="button"
                                    ...
                                    data-key="t-two-step-verification"> Q-Deal
                                </a>
                                <div class="collapse menu-dropdown" id="sidebarTwoStep">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="{{route('qdeal')}}" class="nav-link" data-key="t-basic"> Q-Deal
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{route('qdeal_tran')}}" class="nav-link" data-key="t-cover">   Market Activity
                                            </a>
                                        </li>
                ...
                {{-- <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarForms" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="ri-file-list-3-line"></i> <span data-key="t-forms">Settlement</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarForms">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="#" class="nav-link" data-key="t-basic-elements">Unsettled 
                                    Transactions</a>
                            </li>
